...
1. 使用了全注意力
   ![full-attention](/deeplearnning/paper/full-attention.png)
2. 一次预测未来N个值
3. 两种模式(motion, music)的提前融合

最后附上模型架构图

![Full-Attention-Cross-model-Transform](/deeplearnning/paper/Full-Attention-Cross-model-Transform.png)
...
2. 多模态motion GPT
   ...
   ![cross-conditional-causal-attention](/deeplearnning/paper/cross-conditional-causal-attention.png)
...
![bailando](/deeplearnning/paper/bailando.png)
...
![PopDanceSet](/deeplearnning/paper/PopDanceSet.png)
...
![POPDG](/deeplearnning/paper/POPDG.png)
...
![EDGE](/deeplearnning/paper/EDGE.png)
